...
class VisADataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.region_split_eval = bool(kwargs.get("region_split_eval", 0))
        self.aperture_ratio = float(np.clip(kwargs.get("aperture_ratio", 0.25), 0.0, 1.0))
        self.region_center_x = float(kwargs.get("region_center_x", -1.0))
        self.region_center_y = float(kwargs.get("region_center_y", -1.0))
        self.vis_save_size = int(kwargs.get("vis_save_size", 256))
